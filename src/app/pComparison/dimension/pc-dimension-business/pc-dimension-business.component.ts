...
@Component({
  selector: 'app-pc-dimension-business',
  templateUrl: './pc-dimension-business.component.html',
  styleUrls: ['./pc-dimension-business.component.css']
})
export class PCDimensionBusinessComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.listKPIs = this.f.getTypeDimensionKPIsList(constants.KPI_dimension.B);
