...
@Component({
  selector: 'app-pc-dimension-contextual',
  templateUrl: './pc-dimension-contextual.component.html',
  styleUrls: ['./pc-dimension-contextual.component.css']
})
export class PCDimensionContextualComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.listKPIs = this.f.getTypeDimensionKPIsList(constants.KPI_dimension.C);
