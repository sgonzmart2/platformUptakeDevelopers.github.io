...
@Component({
  selector: 'app-pc-user-euc',
  templateUrl: './pc-user-euc.component.html',
  styleUrls: ['./pc-user-euc.component.css']
})
export class PCUserEUCComponent implements OnInit {
  ...
  cluster_id: number = this.f.getKPIClusterIdByAbbreviation(constants.KPI_cluster.EUC);
  ...
  ngOnInit() {
    ...
    this.listKPIs = this.f.getTypeClusterKPIsList(constants.KPI_cluster.EUC);
