...
@Component({
  selector: 'app-pc-user-peu',
  templateUrl: './pc-user-peu.component.html',
  styleUrls: ['./pc-user-peu.component.css']
})
export class PCUserPEUComponent implements OnInit {
  ...
  isLoadingKPIsValues = true; cluster_id: number = this.f.getKPIClusterIdByAbbreviation(constants.KPI_cluster.PEU);
  ...
  ngOnInit() {
    ...
    this.listKPIs = this.f.getTypeClusterKPIsList(constants.KPI_cluster.PEU);
