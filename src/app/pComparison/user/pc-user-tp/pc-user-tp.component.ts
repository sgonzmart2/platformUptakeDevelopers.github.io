...
@Component({
  selector: 'app-pc-user-tp',
  templateUrl: './pc-user-tp.component.html',
  styleUrls: ['./pc-user-tp.component.css']
})
export class PCUserTPComponent implements OnInit {
  ...
  isLoadingKPIsValues = true; cluster_id: number = this.f.getKPIClusterIdByAbbreviation(constants.KPI_cluster.TP);
  ...
  ngOnInit() {
    ...
    this.listKPIs = this.f.getTypeClusterKPIsList(constants.KPI_cluster.TP);
